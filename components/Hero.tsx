  ...
  return (
    <div className="relative overflow-hidden bg-[#0B0F19] pt-12 pb-24 md:pt-20 md:pb-40 min-h-[90vh] flex items-center">
      ...
      <div className="absolute inset-0 pointer-events-none z-0">
          <div 
            className="absolute top-0 right-0 -translate-y-1/4 translate-x-1/4 w-[300px] md:w-[600px] h-[300px] md:h-[600px] bg-gradient-to-br from-indigo-600 to-purple-600 rounded-full blur-[80px] md:blur-[120px] opacity-40 transition-transform duration-300 ease-out will-change-transform" 
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col-reverse lg:flex-row items-center w-full z-10">
        ...
        <div className="w-full lg:w-1/2 text-center lg:text-left space-y-6 md:space-y-8 mt-12 lg:mt-0 relative z-20">
          ...
          {/* Action Buttons - EXTREMELY HIGH Z-INDEX for Mobile Safety */}
          <div className="animate-entry delay-400 flex flex-col sm:flex-row items-center justify-center lg:justify-start space-y-3 sm:space-y-0 sm:space-x-4 pt-4 px-4 sm:px-0 relative z-[100] pointer-events-auto">
            <button
